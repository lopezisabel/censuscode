...
target_fips<-targetcoastal_FIPS
...
hurdat3 <- filter(hurdat2, fips %in% targetcoastal_fips ) %>% 
...
saveRDS(target_hurdat, file = here("data","target_hurdat"))
saveRDS(hurdat4, file = here("hurdat4.Rds"))
```
