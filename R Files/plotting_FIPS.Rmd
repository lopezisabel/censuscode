...
ggplot() +
  geom_line(aes(year, month2_emplvl, color=source), lwd = 1.25) +
  labs(title = "Employment Level in Monroe County",
         y = "Second Month in any given Quater,Q2",
         x = "") +
...
#Employment level for the first month of a given quarter, Q3
# Florida
# filter(all_leisuredata3, area_fips==12087) %>% 
