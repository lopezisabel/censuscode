...
filter(all_targetdata, area_fips==12087, industry_code %in% target_naic_industry_codes,qtr==1) %>% 
ggplot() +
...
filter(all_targetdata, area_fips==12087, industry_code %in% target_sicindustry_codes,qtr==1) %>% 
ggplot() +
  geom_line(aes(year, month1_emplvl, color=source), lwd = 1.25) +
