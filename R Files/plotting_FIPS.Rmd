...
vertical_lines <- filter(targethurdat1, fips=="12005")
...
ggplot() + 
  ...
  geom_line(data = filter(all_leisuredata,area_fips == '12005'& industry_title == "Retail Trade Division"),
  ...
  geom_vline(aes(xintercept = as.Date(time), color = type),vertical_lines)+
  labs(title = "Title",
       subtitle = "Subtitle",
       x = "Year",
       y = "Average Weekly Wage")
